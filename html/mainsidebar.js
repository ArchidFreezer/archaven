  ...
  <div class="w3-dropdown-click">
    ...
    <div id="bbDrop" class="w3-dropdown-content w3-bar-block w3-white w3-card">
      <a href="bb-main.html" class="w3-bar-item w3-button">Overview</a>
			...
			<a href="bb-tempo.html" class="w3-bar-item w3-button">Tempo</a>
    </div>
  </div>
  <div class="w3-dropdown-click">
  ...
  <div class="w3-dropdown-click">
    ...
    <div id="dfDrop" class="w3-dropdown-content w3-bar-block w3-white w3-card">
      <a href="df-main.html" class="w3-bar-item w3-button">Overview</a>
			...
			<a href="df-ranged-heal.html" class="w3-bar-item w3-button">Ranged/Healer</a>
			<a href="df-ranged-striker.html" class="w3-bar-item w3-button">Ranged Striker</a>
			<a href="df-tank.html" class="w3-bar-item w3-button">Spiky Ball</a>
    </div>
  </div>
  <div class="w3-dropdown-click">
